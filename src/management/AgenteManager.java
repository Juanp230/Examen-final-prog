...
public class AgenteManager {
    ...
    public void registrarAgente() {
        ...
        string nivelHabilidad= ConsoleUtils.leerTexto("Ingrese el nivel de la habilidad del agente")

        Agente nuevoAgente = new Agente(id, nombre, habilidad , nivelHabilidad);
